...
- **2022.07.04(howard)**: Seastar 打开 `poll-mode` 和保留 512 MB 内存给 OS 之后终于出分了，也是很低分，可能是 zset 或者 KV 实现有问题，两个框架都这么低分，score:1621.3732, init_score:10.0000, api_score:630.0000, qps_score:981.3232, delay_score:0.0500
